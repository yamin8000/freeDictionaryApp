 ...
 *     WiktionaryAPI.kt Copyrighted by Yamin Siahmargooei at 2026/6/24
 *     WiktionaryAPI.kt Last modified at 2026/6/24
...
interface WiktionaryAPI {
    ...
    suspend fun search(@Path("term") term: String): List<Any>
}