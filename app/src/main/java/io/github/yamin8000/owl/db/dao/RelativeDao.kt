/*
 *     Owl/Owl.app.main
 *     RelativeDao.kt Copyrighted by Yamin Siahmargooei at 2022/12/27
 *     RelativeDao.kt Last modified at 2022/12/27
...
interface RelativeDao {
    ...
    suspend fun getWordsWithDefinitions(): List<WordEntity>
}