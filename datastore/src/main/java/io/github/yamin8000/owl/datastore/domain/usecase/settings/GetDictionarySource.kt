 ...
 *     GetDictionarySource.kt Copyrighted by Yamin Siahmargooei at 2026/6/24
 *     GetDictionarySource.kt Last modified at 2026/6/24
...
class GetDictionarySource(
    private val repository: SettingsRepository
) {
    suspend operator fun invoke(): DictionarySource {
        return repository.getDictionarySource()
    }
}